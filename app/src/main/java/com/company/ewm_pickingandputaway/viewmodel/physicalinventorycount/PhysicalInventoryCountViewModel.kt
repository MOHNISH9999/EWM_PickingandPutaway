package com.company.ewm_pickingandputaway.viewmodel.physicalinventorycount
...
/*
 * Represents View model for PhysicalInventoryCount
 *
 ...
 */
class PhysicalInventoryCountViewModel(application: Application): EntityViewModel<PhysicalInventoryCount>(application, EntitySets.physicalInventoryCountSet, PhysicalInventoryCount.phyInvDocGUID) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<PhysicalInventoryCount>(application, EntitySets.physicalInventoryCountSet, PhysicalInventoryCount.phyInvDocGUID, navigationPropertyName, entityData)
    }
}
