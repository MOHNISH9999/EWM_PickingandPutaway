package com.company.ewm_pickingandputaway.service
...
object OfflineWorkerUtil {
    ...
    lateinit var cRVWM_PHYSICALINVENTORY_SRV_Entities: CRVWM_PHYSICALINVENTORY_SRV_Entities
        private set
    ...
    private const val CONNECTION_ID_CRVWM_PHYSICALINVENTORY_SRV_ENTITIES = "com.sap.pickingTestewmPick"
    ...
    fun initializeOffline(
        ...
        try {
            val url = URL(serviceUrl + CONNECTION_ID_CRVWM_PHYSICALINVENTORY_SRV_ENTITIES)
            ...
            offlineODataProvider = OfflineODataProvider(
                ...
                val physicalInventoryCountSetQuery = OfflineODataDefiningQuery("PhysicalInventoryCountSet", "PhysicalInventoryCountSet", false)
                addDefiningQuery(physicalInventoryCountSetQuery)
                val repackHuItemSetQuery = OfflineODataDefiningQuery("RepackHuItemSet", "RepackHuItemSet", false)
                addDefiningQuery(repackHuItemSetQuery)
                cRVWM_PHYSICALINVENTORY_SRV_Entities = CRVWM_PHYSICALINVENTORY_SRV_Entities(this)
            }
        } catch (e: Exception) {
