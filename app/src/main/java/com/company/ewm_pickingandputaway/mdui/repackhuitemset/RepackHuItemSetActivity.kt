 ...
 * - [RepackHuItemSetCreateFragment]: to create or edit a(n) RepackHuItem,
 * - [RepackHuItemSetDetailFragment]: to display the details of a(n) RepackHuItem,
 * - [RepackHuItemSetListFragment]: to list RepackHuItemSet.
 *
 ...
 * what to do.
 */
class RepackHuItemSetActivity : AppCompatActivity(), InterfacedFragment.InterfacedFragmentListener<RepackHuItem> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, RepackHuItemSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit()
        } else {
    ...
    override fun onFragmentStateChange(evt: Int, entity: RepackHuItem?) {
        when (evt) {
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link RepackHuItemSetCreateFragment}.
     */
    ...
    private fun onItemClicked(entity: RepackHuItem?) {
        if (!isMasterDetailView) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, RepackHuItemSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if (detail == null) {
                if (entity != null)
                    supportFragmentManager.beginTransaction()
                        .replace(R.id.detailFrame, RepackHuItemSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                        .commit()
            } else {
                if( entity == null) {
    ...
    private fun onCreateNewItem() {
        ...
        val fragment = RepackHuItemSetCreateFragment()
    ...
    @Suppress("UNUSED_PARAMETER")
    private fun onEditItem(entity: RepackHuItem?) {
        val updateFragment = RepackHuItemSetCreateFragment()
        val arguments = Bundle()
    ...
    internal class ConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button) { _, _ ->
                (fragmentActivity as RepackHuItemSetActivity).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null)
            }
    ...
    internal class DeleteConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            val fragmentActivity = requireActivity() as AppCompatActivity
            val builder = MaterialAlertDialogBuilder(fragmentActivity, R.style.AlertDialogStyle)
            val viewModel = ViewModelProvider(fragmentActivity)[RepackHuItemViewModel::class.java]
