...
import com.company.ewm_pickingandputaway.databinding.ActivityEntityitemBinding
...
import com.company.ewm_pickingandputaway.mdui.EntitySetListActivity
 ...
 * - [WarehouseTaskExceptionCodeCreateFragment]: to create or edit a(n) WarehouseTaskExceptionCodeType,
 * - [WarehouseTaskExceptionCodeDetailFragment]: to display the details of a(n) WarehouseTaskExceptionCodeType,
 * - [WarehouseTaskExceptionCodeListFragment]: to list WarehouseTaskExceptionCode.
 *
 ...
 * what to do.
 */
class WarehouseTaskExceptionCodeActivity : AppCompatActivity(), InterfacedFragment.InterfacedFragmentListener<WarehouseTaskExceptionCodeType> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, WarehouseTaskExceptionCodeListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit()
        } else {
    ...
    override fun onFragmentStateChange(evt: Int, entity: WarehouseTaskExceptionCodeType?) {
        when (evt) {
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link WarehouseTaskExceptionCodeCreateFragment}.
     */
    ...
    private fun onItemClicked(entity: WarehouseTaskExceptionCodeType?) {
        if (!isMasterDetailView) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.masterFrame, WarehouseTaskExceptionCodeDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if (detail == null) {
                if (entity != null)
                    supportFragmentManager.beginTransaction()
                        .replace(R.id.detailFrame, WarehouseTaskExceptionCodeDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                        .commit()
            } else {
                if( entity == null) {
    ...
    private fun onCreateNewItem() {
        ...
        val fragment = WarehouseTaskExceptionCodeCreateFragment()
    ...
    @Suppress("UNUSED_PARAMETER")
    private fun onEditItem(entity: WarehouseTaskExceptionCodeType?) {
        val updateFragment = WarehouseTaskExceptionCodeCreateFragment()
        val arguments = Bundle()
    ...
    internal class ConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button) { _, _ ->
                (fragmentActivity as WarehouseTaskExceptionCodeActivity).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null)
            }
    ...
    internal class DeleteConfirmationDialogFragment : DialogFragment() {
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            val fragmentActivity = requireActivity() as AppCompatActivity
            val builder = MaterialAlertDialogBuilder(fragmentActivity, R.style.AlertDialogStyle)
            val viewModel = ViewModelProvider(fragmentActivity)[WarehouseTaskExceptionCodeTypeViewModel::class.java]
