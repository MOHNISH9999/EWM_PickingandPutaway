package com.company.ewm_pickingandputaway.app
...
import com.company.ewm_pickingandputaway.databinding.ActivityMainBusinessBinding
import com.company.ewm_pickingandputaway.mdui.EntitySetListActivity
import com.company.ewm_pickingandputaway.service.OfflineBaseWorker
import com.company.ewm_pickingandputaway.service.OfflineOpenWorker
import com.company.ewm_pickingandputaway.service.OfflineProgressListener
...
class MainBusinessActivityT2 : AppCompatActivity() {
        ...
        dialogFragment = DialogHelper.ErrorDialogFragment(
            ...
            positiveAction =  {
                if (!isOfflineStoreInitialized) {
                    application.getSystemService(NotificationManager::class.java).cancel(
                        OfflineBaseWorker.OFFLINE_NOTIFICATION_CHANNEL_INT_ID)
    ...
    private fun offlineNetworkErrorAction() {
        this@MainBusinessActivityT2.runOnUiThread {
